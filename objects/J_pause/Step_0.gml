...
if (keyboard_check_pressed(ord("R"))) 
{
	if (!global.pause)
	{
		...
		instance_deactivate_layer("Instance_Player")
		...
		layer_set_visible("Instances_Player", false)
		layer_set_visible("Instances_walls", false)
		layer_set_visible("Instance_Enemy", false)
		...
		layer_set_visible("Instances_3", false)
		layer_set_visible("Instances_egg", false)
		layer_set_visible("Instances_camera_tiles", false)
		layer_set_visible("Tiles_breakwalls", false)
		layer_set_visible("Castle_tiles_expansion", false)
		layer_set_visible("Tiles_details_expansion", false)
		layer_set_visible("Castle_tiles_expansion", false)
		layer_set_visible("Tiles_details", false)
		layer_set_visible("Castle_tiles", false)
		layer_set_visible("Instances_portareas", false)
		layer_set_visible("Instances_walls", false)
	...
	else 
	{
		...
		layer_set_visible("Instances_Player", true)
		layer_set_visible("Instances_walls", true)
		...
		layer_set_visible("Instances_3", true)
		layer_set_visible("Instances_egg", true)
		layer_set_visible("Instances_camera_tiles", true)
		layer_set_visible("Tiles_breakwalls", true)
		layer_set_visible("Castle_tiles_expansion", true)
		layer_set_visible("Tiles_details_expansion", true)
		layer_set_visible("Castle_tiles_expansion", true)
		layer_set_visible("Tiles_details", true)
		layer_set_visible("Castle_tiles", true)
		layer_set_visible("Instances_portareas", true)
		layer_set_visible("Instances_walls", true)
		...
		instance_activate_layer("Instance_Player")
