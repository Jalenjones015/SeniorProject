...
if active == SpecialWeapon
{
	if image_angle = 0
	{
	instance_create_depth(active.x + 55, active.y + -30, depth - 1, OBJ_SpecialHitbox)
	}
}
...
if active == SpecialWeapon
{
	if image_angle = 270
	{
	instance_create_depth(active.x + -30, active.y + 55, depth - 1, OBJ_SpecialHitbox2)
	}
}