		...
		if weapon2
		{
			if (image_angle = 90 or image_angle = 0 or image_angle = 180 or image_angle = 270)
			{
				...
				if (is_swinging)
				{
					...
					weapon2.sprite_index = SpecialWeapon;			
					alarm_set(0, 3);
					show_debug_message("Swing");
				}
			}
